...
| Research stream | Main information | Typical decision or output | Representative linked papers | Verified code |
|---|---|---|---|---|
...
| State estimation and prediction | Detector events, probe trajectories, SPaT/MAP | Queue, arrival profile, turning demand, near-term state | [Liu et al.](https://doi.org/10.1016/j.trc.2009.02.003); [Tan et al.](https://doi.org/10.1109/TITS.2019.2954937); [DCRNN](https://openreview.net/forum?id=SJiHXGWAZ); [STGCN](https://doi.org/10.24963/ijcai.2018/505) | [DCRNN](https://github.com/liyaguang/DCRNN); [STGCN](https://github.com/VeritasYin/STGCN_IJCAI-18) |
